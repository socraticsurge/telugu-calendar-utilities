...
CONSUMED_FIELDS = (
    ...
    'skip_on_yoga', 'skip_on_sankramana', 'prefer_vara',
    'prefer_tithi_class', 'avoid_tithi_class',
    'required_lagna_class', 'allowed_maasams', 'allowed_maasa_solar_pairs',
    'allowed_varas',
    ...
    'caution_lagna_solar',
    'source_claim', 'source_scope', 'audit_claim', 'heuristic_claim',
    'related_claims',
    'daytime_only',
