...
def test_architecture_report_maps_modules_consumers_and_layers():
    ...
    assert report['scope']['source_files'] == 106
    assert report['scope']['established_source_files'] == 78
    assert report['scope']['additive_feature_source_files'] == 28
    assert report['scope']['total_source_files'] == 106
    ...
    assert 'Production modules: 106' in summary
    assert 'Established production modules: 78' in summary
    assert 'Additive feature modules: 28' in summary
