...
def test_architecture_report_maps_modules_consumers_and_layers():
    ...
    assert 'Production modules: 114' in summary
...
def test_same_rasi_conjunction_assessors_extend_architecture_additively():
    assert source_scope_class(
...
def test_benefic_pattern_assessors_extend_architecture_additively():
    assert source_scope_class(
