...
def test_vidyarambha_lineages_and_copy_variance_are_explicit():
    ...
    assert 'fifth edition' in sources['MC-NSP-1945-5E']['edition'].lower()
    assert 'Nirnaya Sagar Press' in sources['MC-NSP-1945-5E']['edition']
    assert sources['MC-NSP-1945-5E']['url'] == (
        'https://jainqq.org/booktext/Muhurt_Chintamani/002342')
