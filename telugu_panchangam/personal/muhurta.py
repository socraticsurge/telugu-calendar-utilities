...
def day_slots(day: PanchangamDay, activity: str = 'any',
    ...
    for block in day.choghadiya:
        ...
        for s, e in _subtract(block.start, block.end, bad):
            ...
            elif tara_unfav_names and not any(y in ('Sarvartha Siddhi Yoga', 'Amrita Siddhi Yoga') for y in facts.special_yogas):
            ...
            if tithi_fam == 'Rikta' or 'Amavasya' in facts.tithi:
                day_dosha = 'rikta_tithi' if tithi_fam == 'Rikta' else 'amavasya'
