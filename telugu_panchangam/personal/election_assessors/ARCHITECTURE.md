...
| benefic Rasi | `benefic_rasi.py` | `benefic-rasi.ts` | Classical Rasi ownership plus resolved natural nature only; occupancy, dignity, strength and event effects stay outside |
