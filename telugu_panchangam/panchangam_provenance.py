...
_GROUPS = (
    ...
    {
        'id': 'traditional_windows',
        'fields': (
            'auspicious', 'inauspicious', 'bhadra_mukha', 'bhadra_puchha',
            'sankramana_avoidance', 'choghadiya',
        ),
        'claim_id': 'panchangam.traditional_windows',
        'state': 'needs_locator',
        'note': 'The formulas are regression-tested but do not yet share one inspected textual authority.',
    },
    {
    ...
    {
        'id': 'derived_traditional_classifications',
        'fields': (
            ...
            'nakshatra_mukha', 'panchaka_rahita',
        ),
