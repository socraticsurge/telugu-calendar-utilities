...
These files provide review evidence only. The owner accepted the reviewed
captures on 2026-09-05. The v1.18 implementation is restacked after v1.17.0;
PR merge and deployment remain separate release gates.
