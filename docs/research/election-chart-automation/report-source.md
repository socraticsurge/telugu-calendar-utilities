...
|---|---|---|
| `BVR-MUHURTHA-1993` | B. V. Raman, *Muhurtha (Electional Astrology)*, Chapter X, “Buying Jewelry,” printed p. 45, PDF p. 49 in the registered scan. The same passage is inspectable in a [public mirror, PDF pp. 68–69](https://lakshminarayanlenasia.com/articles/Muhurtha-Electional-Astrology.pdf). | Event clause: Surya and Chandra should be well situated and aspected; unfavorable lunar days and asterisms should be avoided. |
...
The canonical contract now contains **29 deterministic chart predicates
across 14 activity profiles**. These are current counts; the earlier 23/12
figures above remain explicitly dated pre-Gold history. Gold remains the only
declared complete event assessor. Aksharabhyasa's two Chapter VIII clauses are
automated, but the overall assessment remains partial/provisional because the
shared general election-chart baseline is not yet complete.
...
After Aksharabhyasa passes owner review, the next bounded stories are
Annaprasana, Karnavedha, completed-house purchase, general purchase,
