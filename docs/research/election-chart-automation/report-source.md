...
|---|---|---|
| `BVR-MUHURTHA-1993`; `BVR-MUHURTHA-CHISTABO-2020` | B. V. Raman, Chapter VIII, Chistabo derivative internal printed p. 22 / physical PDF p. 25 | The UBS ID preserves the bibliographic work identity; the inspected derivative supplies the located wording for the six-clause named policy. |
