...
[Inspect the registered 2020 Chistabo derivative.](https://www.panchanga.lv/wp-content/uploads/2020/06/Muhurta_Raman.pdf)
...
|---|---|---|---|
| `karnavedha.daylight-tithi-single` | Selected-system local Panchangam day | The Tithi active at sunrise has no transition inside `[sunrise, sunset)` | Reject the complete day on fail or unknown |
| `karnavedha.daylight-nakshatra-single` | Selected-system local Panchangam day | The Nakshatra active at sunrise has no transition inside `[sunrise, sunset)` | Reject the complete day on fail or unknown |
...
The oracle in this release pins representative Drik days; the fail-closed
daylight algorithm itself runs on whichever Panchangam system the user selected.
