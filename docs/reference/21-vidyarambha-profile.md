...
The public activity label is **Aksharabhyasa (First-letter writing)**. The
stable compatibility and API identifier remains `vidyarambha` so saved links,
MCP callers, and existing integrations do not break.

This v1 assessor represents only the first-letter-writing rite described under
Chapter VIII. It does not claim to assess starting school, a new subject,
higher study, music, medicine, a trade, or the broader educational elections
in Chapter XI.
...
Registered source ID: `MC-NIRNAYASAGAR-1945-JAINQQ`. These verses do not
