...
| 10 | [Computation contributor workflow](10-computation-contributor-workflow.md) | Safe ownership decision, evidence/test/release gates, copyable template, and a complete additive example |
| — | [Computation record template](computation-record-template.md) | Copyable GitHub-story worksheet, inventory JSON record, and PR checklist |
...
| 54 | [Muhurtam election-chart screening](54-muhurtam-election-chart-screening.md) | Privacy-minimal DashaFlow enrichment, 29-rule matrix, complete-assessor claims, rejected-rule evidence, boundary semantics and manual remainder |
