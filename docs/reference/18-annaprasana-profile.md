...
“B. V. Raman, Chapter VIII, ‘First feeding on rice (Annaprasana),’ inspected
in the 2020 Chistabo derivative at internal printed p. 22 (physical PDF p.
25).”
...
conflicting lists. This is an engineering-policy claim with no direct source
IDs. It depends on the separately registered textual claims
`muhurta.annaprasana.raman_transcription_chart` and
`muhurta.annaprasana.source_divergence`, which carry the external source IDs
and exact artifact/page locators.
